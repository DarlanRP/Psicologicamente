  ...
  return (
    <FaqContainer>
      <FaqContainerItem>
        ...
        <FaqItem
          question="O esperar do processo terapêutico?"
        ...
        <FaqItem
          question="O esperar do processo terapêutico infantil?"
          answer="O processo terapêutico infantil oferece à criança um espaço seguro e acolhedor,
                  ...
                  Os pais também fazem parte desse caminho, recebendo orientações e acompanhando cada etapa."
        />
